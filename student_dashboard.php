...
@media(max-width:375px){
  ...
  .topbar-right{gap:8px; flex-wrap:wrap; width:100%; justify-content:flex-end;}
  ...
  .membership-inner{flex-direction:column; gap:12px;}
  .membership-right{text-align:left;}
  .membership-name{font-size:1.05rem;}
  .calendar-grid{gap:2px;}
  .cal-day{height:28px; font-size:.68rem;}
  .cert-grid-2{gap:8px;}
  ...
  .membership-card::before,.membership-card::after{width:120px; height:120px;}
  .stat-card::after{width:70px; height:70px;}
  .achievement-badge{padding:12px; gap:10px;}
  .ach-icon{width:36px; height:36px;}
  .ach-info b{font-size:.82rem;}
  .logo-container{gap:6px;}
  .logo-container img{width:26px; height:26px;}
}
</style>
</head>
<body id="top">
