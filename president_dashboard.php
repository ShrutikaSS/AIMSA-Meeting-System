...
<div class="drawer" id="scheduleMeetingDrawer">
  ...
  <form id="scheduleMeetingForm" onsubmit="submitScheduleMeeting(event)">
    <div class="form-group">
      ...
      <input type="text" id="meetTitle" placeholder="e.g. Executive Committee Strategy Sync" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" id="meetTime" placeholder="e.g. 03:30 PM" value="03:30 PM" required>
    </div>
    <div class="form-group">
      <label>Venue / Location / Meeting Link</label>
      <input type="text" id="meetVenue" placeholder="e.g. AIML Seminar Hall / Google Meet link" required>
    </div>
    <div class="form-group">
      ...
      <select id="meetCategory">
        ...
        <option value="Workshop Sync">Workshop &amp; Event Planning</option>
...
async function fetchScheduledMeetings() {
  ...
  try {
    const res = await fetch('ajax/president_actions.php?action=get_meetings');
    const data = await res.json();
